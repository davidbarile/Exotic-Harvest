...
public class Pool : MonoBehaviour
{
    ...
    private static Dictionary<string, GameObject> PrefabDictionary => IN.prefabLookup.PrefabDictionary;
    ...
    public static T Spawn<T>(string inName, Transform inParent, Vector3 inPosition = default, Quaternion inRotation = default) where T : Component
    {
